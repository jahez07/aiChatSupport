import {NextApiRequest, NextApiReponse} from "next";
...
const uploadDocumentToPinecone = async (pageContent = string, metadata) => {
    ...
    await PineconeStore.fromDocuments([document], new GoogleGenerativeAIEmbeddings(),{
        pineconeIndex,
    });
...
// Extract the content of the dic with the given class name from the website
